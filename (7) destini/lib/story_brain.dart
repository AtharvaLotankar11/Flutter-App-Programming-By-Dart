...
class StoryBrain {
  ...
  // Private variable to keep track of the story state
  int _storyNumber = 0;

  // Returns the story title for the current story number
  String getStory() {
  ...
  // Updates the story number based on the user's choice
  ...
  // Determines whether the choice buttons should be visible
